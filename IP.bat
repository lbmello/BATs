...
REM [Script para configuração de IP em estações Windows - NECESSITA SER EXECUTADO COMO ADMINISTRADOR - Pode ser executado em estações com várias interfaces de rede]
